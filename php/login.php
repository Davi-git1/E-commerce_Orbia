  ...
  <main class="main">
    <div  class="formLogin">
      <form action="" method="post">
        <h2 align="center" style="padding-bottom:40px;color:#f7f7f7;">Login Orbia</h2>
      <div class="area">
        <input type="email" name="email" required class="campoCadastro input" placeholder="Digite seu E-mail" />
        <div class="labelline">E-mail*</div>
      </div>

      <div class="area">
        <input type="password" name="senha" required class="campoCadastro input" placeholder="Digite sua Senha" />
        <div class="labelline">Senha*</div>
      </div>
      <?php if (!empty($erro)) { echo "<p style='color:red;text-align:center;font-size:small;'>$erro</p>"; } ?>
      <div class="btnEnviar">
        <input type="submit" value="ENVIAR" class="campoCadastro btnEnviar2" />
      </div>
      <a href="esqueciSenha.php" class="ancora-entrar" style="font-size: small;color:#d3c6e1;">Esqueci Senha!</a>
    </form>
    </div>
  </main>
</body>
